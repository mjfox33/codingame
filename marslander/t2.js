...
const initialState = {
  X: 6500, Y: 2800, hSpeed: -100, vSpeed: 0, fuel: 600, rotate: 90, power: 0
};
const landingX = 2250, landingY = 100;
const landingXMin = 2000, landingXMax = 2500;

// Test 1 commands
const initialCommands = commands[1] || [];

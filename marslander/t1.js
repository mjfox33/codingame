...
const initialState = {
  X: 2500, Y: 2700, hSpeed: 0, vSpeed: 0, fuel: 550, rotate: 0, power: 0
};
const landingX = 4750, landingY = 150;
const landingXMin = 4000, landingXMax = 5500;

// Test 1 commands
const initialCommands = commands[0] || [];
